...
namespace DataStructure.Test
{
    public class MyArrayListTest
    {
      ...
      //      myList.addAll(list);
      //      myList.addAll(list);
      //      Assert.Equal(myList.size(), is (12));
      //      Assert.Equal(myList.get(5), is (new Integer(3)));
      //  }
      ...
      //  {
      //      Assert.Equal(myList.contains(1), equalTo(true));
      //      Assert.Equal(myList.contains(4), equalTo(false));
      //      Assert.Equal(myList.contains(null), equalTo(false));
      //      myList.add(null);
      //      Assert.Equal(myList.contains(null), equalTo(true));
      //  }
      ...
      //  {
      //      Assert.Equal(myList.containsAll(list), equalTo(true));
      //  }
